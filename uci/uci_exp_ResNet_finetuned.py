...
for dataset_id in id_list:
    ...
    for seed in c.seed_list:
        ...
        for config in c.param_grid_ResNet:
            ...
            resnet, train_loss_src, val_loss_src = train_mlp_on_source(dataloader_train_source, resnet, learning_rate=learning_rate, epochs=1000)
            ...
            resnet, train_loss_tgt, val_loss_tgt = finetune_mlp_on_target(train_dataloader, val_dataloader, resnet, epochs=1000, learning_rate=learning_rate)
            ...
            df_exp.to_csv(f'results/ResNet_finetuned_{dataset_id}.csv', index=False)