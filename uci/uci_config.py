...
lr_list = [0.1, 0.5, 1.0]
n_estimators_list = [10,20,30,40,50]#[10, 20, 30, 50, 100, 150]
tree_size_list = [1,2,3,4]
n_estimators_fs_list = [10] #only for two-stage
cv_list = [5] #only for two-stage
...
dropout_list = [0.0, 0.1, 0.2] #15
d_main_list = [64, 128, 256]  #45
num_blocks_list = [2, 3, 4] #135
