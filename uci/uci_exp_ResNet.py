...
for dataset_id in id_list:
    ...
    for seed in c.seed_list:
        ...
        # NOTE: param_grid_ResNet needs to be defined in uci_config (e.g., [(1e-3, 0.2, 64, 2), ...])
        for config in c.param_grid_ResNet:
            ...
            # NOTE: Assuming finetune_mlp_on_target and test_final_mlp handle arbitrary nn.Module types natively
            ...
            df_exp.to_csv(f'results/ResNet_target_only_{dataset_id}.csv', index=False)