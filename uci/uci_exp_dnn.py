...
id_list = [925] #InfraRed = 925, concrete = 165, Auto MPG = 9, 
...
for id in id_list:
    ...
    for seed in c.seed_list:
        ...
        mlp = MLP(input_size = np.shape(X_target_test)[0], hidden_size_1=64, hidden_size_2=64, 
        ...
        mlp, train_loss, val_loss = finetune_mlp_on_target(dataloader_train, dataloader_val, mlp, epochs=1000, learning_rate = 5e-5, freeze_layers=None)
