#Script for wall-clock-runtimes
import sys
sys.path.append('../')
...
for n_samples in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]:
    for i in range(50):
        ...
        fiter = LSTransferTreeBoost(epochs=100, v=0.1, source_tree_size=2, #or LAD or M
        ...
        df.to_csv('vizes/runtime_LS.csv') #Add datapoints here and save
